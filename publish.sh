...
# Try to enable GitHub Pages (ignore if already enabled or API is restricted)
GH_PAGES_PAYLOAD=$(printf '{"source":{"branch":"%s","path":"/"}}' "$BRANCH")
